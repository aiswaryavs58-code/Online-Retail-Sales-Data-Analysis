...
The Goal:
To clean the data, analyze it, and clearly explain:
...
2️⃣ Sales Are Higher in Specific Countries

Customers from certain countries place more orders and contribute more to total sales than others.

3️⃣ Sales Increase During Certain Periods

Sales are not the same throughout the year. Some months show higher demand, indicating seasonal buying patterns.

4️⃣ Repeat Customers Exist

Many customers make multiple purchases, showing opportunities for customer loyalty and repeat sales.

5️⃣ Clean Data Makes Better Decisions
...
Matplotlib & Seaborn – Used to create easy-to-understand charts
...
2️⃣ Improve Inventory Planning
Reduce inventory for products that sell very slowly to save storage and costs.

3️⃣ Target High-Performing Countries
Invest more in marketing and logistics for countries with higher sales.

4️⃣ Plan Promotions During High-Sales Periods
Run discounts and offers during months when customers are more active.
...
Size: Large dataset with hundreds of thousands of records

Features: What was sold, how much was sold, price, when it was sold, and where the customer is from

Time Period: Sales data collected over time
✅ Final Note
